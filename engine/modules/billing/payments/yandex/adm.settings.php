...
Class Payment
{
	var $doc = 'https://dle-billing.ru/platezhnye-sistemy/13-yandeks-dengi.html';
	...
	function Form( $id, $payment_config, $invoice, $currency, $desc )
	{
		...
		return '<form method="POST" id="paysys_form" action="https://money.yandex.ru/quickpay/confirm.xml">
