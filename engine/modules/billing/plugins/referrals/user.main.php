...
Class USER
{
	...
	function main( $GET )
	{
		...
		{
			return $this->DevTools->ThemeMsg( $this->DevTools->lang['pay_error_title'], $this->DevTools->lang['cabinet_off'], "referrals" );
		}
		...
		while ( $Value = $this->DevTools->LQuery->db->get_row() )
		{
			...
			$TimeLine = str_replace("{date=".$TplLineDate."}", $this->DevTools->ThemeChangeTime( $Value['payhide_date'], $TplLineDate ), $TimeLine);
