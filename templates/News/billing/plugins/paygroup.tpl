<div id='paygrouptpl' title='Покупка плейлиста "{pay.group_name}"' style='display:none'>
	...
	[pay_ok]
		<p><b>Оплата выполнена</b><br>Вы подключили плейлист {pay.group_name} [pay_time] до {date} [/pay_time] [pay_one][/pay_one]</p>
	[/pay_ok]
