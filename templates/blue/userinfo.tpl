<div class="user-prof">
	...
	<ul class="up-second flex-row">
        ...
        <!--<li><a class="Okno" href="#" onclick="showOkno(); return false;" class="mainlevel">КАК НАС СМОТРЕТЬ!</font></a></li>-->
...
<br>
        <li></li>
		<form>
        <input type="button" value="Скачать SIPTV плейлист" onClick='location.href="http://45.139.184.151:4300/siptv/{usertitle}:{m3pass}:playlist.m3u"'>
        </form>
		<form>
        <input type="button" value="Скачать MPEGTS плейлист" onClick='location.href="http://45.139.184.151:4300/mpg/{usertitle}:{m3pass}:playlist.m3u"'>
        </form>
		<form>
        <input type="button" value="Скачать Enigma2 плейлист" onClick='location.href="http://45.139.184.151:4300/e2/{usertitle}:{m3pass}:playlist.m3u"'>
        </form>
		<li></li>
		<li> <input type="text" style="margin-top: 10px; font-size:16px;" disabled value="Ваши логин: {usertitle}  Ваш пароль: {m3pass}" </li>
		<li> <input type="text" style="margin-top: 10px; font-size:15px;" value="SIPTV | http://watchiptv.ru:4300/siptv/{usertitle}:{m3pass}:playlist.m3u"></li>
		<li> <input type="text" style="margin-top: 10px; font-size:15px;" value="MPEGTS | http://watchiptv.ru:4300/mpg/{usertitle}:{m3pass}:playlist.m3u"></li>
		<li> <input type="text" style="margin-top: 10px; font-size:15px;" value="Enigma2 | http://watchiptv.ru:4300/e2/{usertitle}:{m3pass}:playlist.m3u"></li>
